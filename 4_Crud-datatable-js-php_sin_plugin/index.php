              ...
              <table id="registrados">
                    <thead>
                        <tr>
                          ...
                          <th>Editar</th>
                          <th>
                            <button type="button" name="Borrar" id="btn_borrar" class="fa fa-trash borrar"></button>
                            <input type="checkbox" name="" id="borrar_todos">
                          </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php //dentro parentesis (MYSQLI_ASSOC, MYSQLI_NUM) ?>
                            <tr id="<?php echo $registros['id'] ?>">
                                  ...
                                  <td class="borrar">
                                    <input class="borrar_contacto" type="checkbox" name="<?php echo $registros['id']; ?>" id="">
                                  </td>
                            </tr>
                        <?php } ?>
                    </tbody>
